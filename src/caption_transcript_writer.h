...
#ifndef OBS_GOOGLE_LIVE_CAPTIONS_CAPTION_TRANSCRIPT_WRITER_H
#define OBS_GOOGLE_LIVE_CAPTIONS_CAPTION_TRANSCRIPT_WRITER_H
...
#endif //OBS_GOOGLE_LIVE_CAPTIONS_CAPTION_TRANSCRIPT_WRITER_H
