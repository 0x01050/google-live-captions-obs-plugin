...
#ifndef OBS_GOOGLE_LIVE_CAPTIONS_CAPTIONPLUGINMANAGER_H
#define OBS_GOOGLE_LIVE_CAPTIONS_CAPTIONPLUGINMANAGER_H
...
#endif //OBS_GOOGLE_LIVE_CAPTIONS_CAPTIONPLUGINMANAGER_H
