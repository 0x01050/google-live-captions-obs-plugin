...
#ifndef OBS_GOOGLE_LIVE_CAPTIONS_CAPTIONPLUGINSETTINGS_H
#define OBS_GOOGLE_LIVE_CAPTIONS_CAPTIONPLUGINSETTINGS_H
...
#endif //OBS_GOOGLE_LIVE_CAPTIONS_CAPTIONPLUGINSETTINGS_H
